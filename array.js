...
for(a = 0; a < color.length; a++){
 ...
 let output = (String(string) + " choice is " + color[a] + ".");
...
// Return a new array with those employees below 20
let employeesBelow20 = (employees.filter((x) => x.age < 20));
